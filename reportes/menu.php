...
<div class="navbar">
  <div class="navbar-inner">
    ...
    <table style="width:100%" >
      <tr>
        <td style="width:50%"><a  href="#" class="brand"><strong><small>Sistema de Gestión Administrativo - Empresa DEMO</small></strong></a></td>
      ...
      <ul class="nav" id="color2" style="width:100%">
              ...
              <i class="glyphicon glyphicon-list-alt"></i> Ficha Clientes</a></li>
                  <li class="dropdown submenu">
                   ...
                   <ul class="dropdown-menu submenu-show submenu-hide">
                      <li><a href="area/guiadespacho/guiacrud_main.php" class="tabulador" title="Guía de Despacho">Guía de Despacho</a></li>
                      ...
                      <li><a href="area/pagosayabonos/pagosabonoscrud_main.php" class="tabulador" title="Pagos - Abonos">Pagos - Abonos</a></li>
                   </ul>
                  </li>
                  ...
                  <li class="dropdown submenu">
                   ...
                   <ul class="dropdown-menu submenu-show submenu-hide">
                      ...
                      <li><a href="area/cotizacion/plantillacrud_main.php" class="tabulador" title="Cotizaciones: Plantillas">Plantillas</a></li>
                    ...
                    <li class="dropdown submenu">
                      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                       ...
                       <ul class="dropdown-menu submenu-show submenu-hide">
                         ...
                         <li><a href="#" class="tabulador" title="Compras con Boleta">Boletas</a></li>
                         <li><a href="area/pagosayabonos/pagosabonoscrud_main.php" class="tabulador" title="Pagos/Abonos">Pagos/Abonos</a></li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="area/inventario/traspasobodegas_main.php"weea class="tabulador" title="Inventario: Traspaso Desde Bodegas">
              <i class="glyphicon glyphicon-tags"></i> Inventario: Traspaso Desde Bodegas</a></li>
              <li><a href="area/inventario/vistainventariocrud_main.php"weea class="tabulador" title="Inventario: Vista Inventario">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <i class="glyphicon glyphicon-asterisk"></i> Productos</a></li>
              ...
              <li class="nav-header">
               ...
               <li>
                <a href="crud/proyectos_main.php" class="tabulador" title="Gesti&oacute;n Proyectos">
                     <i class="glyphicon glyphicon-time"></i> Gesti&oacute;n Proyectos</a></li>
              <li><a href="area/OrdenTrabajo/ordencrud_main.php" class="tabulador" title="Gesti&oacute;n OT">
              <i class="glyphicon glyphicon-download-alt"></i> Gesti&oacute;n OT</a></li>
              <li><a href="area/OrdenTrabajo/vbuenocrud_main.php" class="tabulador" title="Seguimiento OT">
              <i class="glyphicon glyphicon-bookmark"></i> Seguimiento OT</a></li>
              <li><a href="area/OrdenTrabajo/plantillacrud_main.php" class="tabulador" title="Plantillas de O.T.">
              <i class="glyphicon glyphicon-list"></i> Plantillas de OT</a></li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="disabled"><a href="#">Solicitudes Insumos</a></li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="dropdown submenu">
                 ...
                 <li class="nav-header">Otras Configuraciones</li>
                ...
                <i class="glyphicon glyphicon-stats"></i> IPC</a></li>
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="disabled"><a href="#" >Comportamientos</a></li>
