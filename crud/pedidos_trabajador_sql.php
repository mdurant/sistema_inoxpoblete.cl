...
try
{
    ...
    $jtSorting=$_GET["1"];
		...
		$group_by ="GROUP BY b.id_trabajador";

		$from="FROM esolicitud a inner join trabajador b on a.id_operario = b.id_trabajador";
        ...
        $sql=<<<QUERY
           ...
           SELECT 
           	a.id_operario, 
						upper(concat(b.nombres,' ',b.apellidop)) as datos_trabajador,
						count(a.id_proyecto) as solicitudes,
						a.estado
					$from
					$where
				 	$limit
