		...
		<tr>
			...
			<table width="100%">
				...
				<tr>
				    ...
				    <td><input type="text" id="bsqrut" name="bsqrut" style="width:100%" placeholder="" class="form-control input-sm ui-corner-all"></td>
				</tr>
			    </tbody>
			</table>
		    </td>
...
*/
		...
		buttons: {
		    ...
		    "Documentar": function() {
				...
				TotalChueques = $("#cantidad_cheques").val();
				...
				$.ajax({
					  ...
					  data: {"idEcompra" : idEcompra, "fechaCompromiso": fechaCompromiso, "IDsuppliers" : IDsuppliers, "montoCuota": montoCuota, "tipo_compromiso": tipo_compromiso, "IDUser": IDUser, "TotalChueques": TotalChueques},
	    ...
	    $("#cantidad_cheques").on("change", function(){
	    	...
	    	alert((totsum / $(this).val()).toFixed(0));
	    	$("#cheques").html("");
