...
<head>
<meta charset="utf-8">
<title>Gestión de Orden Trabajo</title>
<!--
...
<body class="ui-widget">
    <div id="contenedor">
            <div id="tbl_pri">
            <center><h3>Gestión de Orden Trabajo</h3></center>
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
                ...
                <td style="width:150px;">
                    <input <?=$deshabilitar?> type="text" name="contador" style="width: 100%" class="form-control input-sm ui-corner-all"  id="contador" value="<?=$res?>" />
                </td>
                <td style="width:100px;padding-left: 10px" align="left"><label>Cliente</label></td>
                ...
                <td style="padding-left: 10px"><?php if ($accion=='crear'){ ?><label>Buscar Plantilla</label><?php } ?></td>
                ...
                <td  style="padding-left: 10px"><label>Jefe Responsable</label></td>
                <td>
                    <select name="jefe" id="jefe" style="width: 100%" class="form-control input-sm ui-corner-all"  value="">
                                    <option value="0">--Seleccionar--</option>
                                    <?php
                                    for($a=0;$a<sizeof($traba);$a++)
                                    {
                                    ?>
                                    <option value="<?=$traba[$a]["id_trabajador"]?>"><?=strtoupper($traba[$a]["datos_trabajador"])?></option>
                                    <?php
                                    }
                                    ?>
            ...
            <tr>
                ...
                <td ><label>Asociar Proyecto</label></td>
                <td >
                <select name="sproyecto" id="sproyecto" style="width: 100%" class="form-control input-sm ui-corner-all"  value="">
                                    <option value="0">--Seleccionar--</option>
                                    <?php
                                    for($e=0;$e<sizeof($proy);$e++)
                                    {
                                    ?>
                                    <option value="<?=$proy[$e]["id_proyecto"]?>"><?=$proy[$e]["nombre_proyecto"]?></option>
                                    <?php
                                    }
                                    ?>
                                    </select>
                ...
                <td >
                <select name="sempresa" id="sempresa" style="width: 100%" class="form-control input-sm ui-corner-all"  value="">
                                    <option value="0">--Seleccionar--</option>
                                    <?php
                                    for($a=0;$a<sizeof($res2);$a++)
                                    {
                                    ?>
                                    <option value="<?=$res2[$a]["IDEmpresa"]?>"><?=$res2[$a]["RazonSocial"]?></option>
                                    <?php
                                    }
                                    ?>
                                    </select>
