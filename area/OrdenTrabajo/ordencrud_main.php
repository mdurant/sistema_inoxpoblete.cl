...
<head>
<meta charset="utf-8"/>
<title>Gestion de Orden de Trabajo</title>
...
<h4>Gestion de Orden de Trabajo</h4>
            ...
            $('#jt_ordenes').jtable({
                ...
                toolbar: {
                    items: [{
                        ...
                        text: 'Ingresar Nuevo Orden Trabajo',
                        click: function() {
                ...
                fields: {
                    ...
                    */
                    PDF2: {
                        ...
                        $img.on("click", function()
                        {
                            ...
                            window.open("../../reportes/detalle_productos_ot.php?id_orden=" + datos.record.id_orden);
                        });
                        return $img;
                        }
                    },
                    ...
                    */
                    ...
                    PDF: {
                        ...
                        {
                            //alert(datos.record.id_orden);
                            window.open("../../reportes/ordentrabajo.php?id_orden=" + datos.record.contador);
                        });
                        return $img;
                        }
                    },
