...
<script type="text/javascript">
	...
	$(document).ready(function() {
			...
			$('#jt_compra').jtable({
					messages: msg,
					jqueryuiTheme: true,
					title: 'Gesti&oacute;n de Boleta Compra',
					paging: true,
					pageSize: 10,
					sorting: true,
							  ...
							  $img.click(function () {
								  ...
								  $('#jt_compra').jtable('openChildTable',
									  $img.closest('tr'),
									  {
											...
											actions: {
											//	listAction: 'compradet_sql.php?action=list&IDCompra='+ datos.record.id_eboleta,
												listAction:'compradet_sql.php?action=list&IDCompra='+datos.record.id_boleta,
											},
											fields: {
												id_eboleta: {
												  type: 'hidden',
												  defaultValue: datos.record.id_eboleta
												},
												id_dboleta: {
												  key: true,
												  create: false,
							...
							PDF: {
									...
									display: function (datos) {
										...
										$img.on("click", function() {
											...
											window.open("../../reportes/compras-boleta.php?contador=" + datos.record.contador);
