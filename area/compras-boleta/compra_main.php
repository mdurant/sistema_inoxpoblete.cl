...
<body  class="ui-widget">
	<div id="contenedor">
    	  <div id="tbl_pri">
            <center><h3>Boleta de Compra</h3></center>
		<form name="form_tbl" id="form_tbl" action="" method="post">
			<div id="cabecera" class="ui-widget-content ui-corner-all">
				...
				<tbody>
				    ...
				    <tr>
					<td>
						<label for="folio">Nº Boleta</label>
					</td>
					<td>
			...
			<div id="pie">
				...
				<tr>
					<td><button class="btn btn-primary" name="btn-factura" id="btn-factura"  value="">Registrar Boleta</button></td>
				</tr>
			    </table>
...
$(function() {
	...
	$("#dialogproveedor").dialog({
		...
		open: function(ev, ui){
                      $('#frameproveedor').attr('src','../../crud/clientes_main.php');
		},
		modal: true,
		buttons: {
			"Cerrar": function() {
