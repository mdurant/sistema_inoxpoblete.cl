		...
		<div id="cabecera" class="ui-widget-content ui-corner-all">
        		...
        		<input type="hidden" id="total" name="total" value="">
                	<table cellspacing="3" align="center" style="width: 50%;" cellpadding="1">
                    	<tr>
                            <td >Contador</td>
                            <td ><input type="text" name="contador" style="width: 100%;" class="form-control input-sm span2" id="contador" value="<?=$res5?>"/></td>
	...
	<div class="divcabecera ui-widget-header ui-corner-all">
        ...
        <tbody>
		   ...
		   <td width="50px;"><center><input style="border:none; width:100%;"  type="text" disabled name="posicion[]" id="" value="<?=$i*10?>" class="form-control input-sm act"/></center></td>
                   <td width="113px;"><center><input style="border:none; width:100%;"  type="text" name="codigo[]" id="cod_complete" value="" class="form-control input-sm caja_cod cod typeahead cod_complete" data-provide="typeahead"/></center></td>
		   <td width="170px;"><center><input style="border:none;width: 100%;"  type="text" name="descripcion[]" disabled id="" value="" class="form-control input-sm span2 act"/></center></td>
                   <td width="81px;"><center><input style="border:none; width: 100%;"  type="text" name="cantidad[]" disabled maxlength="7" id="" value="" class="form-control input-sm span1 cant"/></center></td>
                   <td width="81px;"><center><input style="border:none;width:100%;"  type="text" name="bodega[]" disabled id="" value="" class="form-control input-sm span1"/></center></td>
                   <td width="81px;"><center><input style="border:none;width:100%;"  type="text" name="descuento[]" disabled id="" value="" class="form-control input-sm span1 desc"/></center></td>
                   <td width="81px;"><center><input style="border:none;width: 100%;" type="text" class="form-control input-sm act" name="precio_unitario[]" id="" disabled value=""/></center></td>
                   <td width="81px;"><center><input style="border:none;width: 100%;" type="text" class="form-control input-sm total act" style="border:none;" name="total_tbl[]" id="" disabled value=""/></center></td>
