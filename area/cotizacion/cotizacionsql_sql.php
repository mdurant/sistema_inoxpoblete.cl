...
try
{
    ...
    if($_GET["action"] == "list")
    {
        ...
        if (!$PERMISOS['LISTAR']=='1'){
            ...
            $jTableResult['Message']= "Cotización :: LISTAR :: Acceso denegado.";
...
QUERY;
    ...
    else if($_GET["action"] == "generarfactura")
    {
        ...
        if (!$PERMISOS['GENERAR_FACTURA']=='1'){
            ...
            $jTableResult = array();
            $jTableResult['Result'] = "ERROR";
            $jTableResult['Message']= "Cotización :: GENERAR_FACTURA :: Acceso denegado.";
            $jTableResult['TotalRecordCount'] = 0;
            $jTableResult['Records'] = array();
...
QUERY;
    ...
    else if($_GET["action"] == "delete")
    {
        ...
        if (!$PERMISOS['ELIMINAR']=='1'){
            ...
            $jTableResult = array();
            $jTableResult['Result'] = "ERROR";
            $jTableResult['Message']= "Cotización :: ELIMINAR :: Acceso denegado.";
            $jTableResult['TotalRecordCount'] = 0;
            $jTableResult['Records'] = array();
