		...
		<div id="cabecera" class="ui-widget-content ui-corner-all">
			...
			<table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
				<tbody>
					...
					<td>
					    <select name="tcotizacion" class="form-control input-sm ui-corner-all span2" <?php if($_GET["id_cotizacion"]){echo "style='display:none'";}else{}  ?> id="tcotizacion" value="">
							<option  value="0">--Seleccionar--</option>
							<?php
								for($d=1;$d<7;$d++)
								{
					...
					<td>
					    <select name="fpago" id="fpago" class="form-control input-sm ui-corner-all span2" value="0" style="width: 100%">
        ...
        <div id="pie">
            ...
            <table border="0" class="table table-condensed table-bordered" cellspacing="2">
            	<tr>
                    ...
                    <td align="right"><button class="btn btn-success" type="button" name="btn-plantilla" id="" value="">Guardar Como Plantilla</button></td>
                </tr>
            </table>
            <div>
