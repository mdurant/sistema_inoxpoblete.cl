...
//$Empresa = $_SESSION['SESS_EMPRESA_ID'];
	...
	// $fecha_ingreso=date('Y-m-d H:i:s');
	 ...
	 $empresa =$_SESSION['SESS_EMPRESA_ID'];
	 $glosa=$_POST["glosa"];
	 $estado_contable="PENDIENTE PAGO";
	 $estado ="activo";
	 $motivo =$_POST["motivo"];
	 $folio =$_POST["folio"];
	 
	$id_ultimo=$tra->insertar_eguia_compra($contador,$proveedor,$orden_compra,$numero_factura,$neto,$iva,$impuesto,$total,$fecha_emision,$fecha_ingreso,$usuario,$empresa,$glosa,$estado_contable,$estado,$motivo,$folio);
