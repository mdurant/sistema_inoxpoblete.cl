...
public function insertar_eguia_compra($numero,$proveedor,$orden_compra,$numero_factura,$neto,$iva,$impuesto,$total,$fecha_emision,$fecha_ingreso,$usuario,$empresa,$glosa,$estado_contable,$estado,$motivo,$folio)
    {
        $query=<<<QUERY
