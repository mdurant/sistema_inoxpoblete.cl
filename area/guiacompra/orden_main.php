...
<head>
<meta charset="utf-8">
<title>Guias de Despacho - Compras</title>
...
<body class="ui-widget">
    <div id="contenedor">
            <div id="tbl_pri">
            <center><h3>Guias de Despacho - Compras</h3></center>
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
                ...
                <td style="width:150px;">
                    <input <?=$deshabilitar?> type="text" name="contador" style="width: 100%" class="form-control input-sm ui-corner-all"  id="contador" value="<?=$contador?>" />
                </td>
                ...
                <td><label>Orden de Compra Nº:</label></td>
                <td>
                    <input style="width: 100%" class="form-control input-sm ui-corner-all" type="text" name="orden_compra" id="orden_compra" />
                </td>
            ...
            <tr>
                ...
                <td >
                  <input style="width: 100%" class="form-control input-sm ui-corner-all" type="text" name="numero_factura" id="numero_factura" />
                </td>
