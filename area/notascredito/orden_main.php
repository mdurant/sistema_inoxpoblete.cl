    ...
    <div id="contenedor">
        ...
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
                <tr>
                <td style="width:110px"><label>Folio Nota Credito:</label></td>
                <td style="width:150px;">
                    <input type="text" name="folio_credito" style="width: 100%" class="form-control input-sm ui-corner-all"  id="folio_credito" value="" />
                </td>
