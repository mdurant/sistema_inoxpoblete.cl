...
<body  class="ui-widget">
	<div id="contenedor">
    	  <div id="tbl_pri">
            <center><h3>Factura de Venta</h3></center>
		<form name="form_tbl" id="form_tbl" action="" method="post">
			<div id="cabecera" class="ui-widget-content ui-corner-all">
				...
				<tbody>
					...
					<td rowspan="3">
					    <textarea class="form-control input-sm ui-corner-all" value="" id="glosa" name="glosa" cols="20" rows="4" style="width:100%;"></textarea>
					</td>
				    </tr>
				    <tr>
					<td>
					...
					<td align="center">
					    <label for="fpago">Cuotas</label>
					</td>
					<td>
					    <select name="fpago" id="fpago" class="span2" value="" style="width: 100%">
					    <option value="0">--Seleccionar--</option>
					    <?php
					    for($c=1;$c<=48;$c++)
					    {
				    ...
				    <tr>
					<td>
					    <label for="facturacion">Fecha Facturación</label>
					</td>
					<td>
			...
			<div id="pie">
				...
				<tr>
					<td><button class="btn btn-primary" name="btn-factura" id="btn-factura"  value="">Generar Factura</button></td>
				</tr>
			    </table>
						...
						$.ajax({
								...
								success: function(response){
										...
										if (response=="todo") {
											...
											window.location = 'facturacrud_main.php';			//code
											return;
										}else
										{
