...
}else
{
    ...
    $contador=$guia->obtiene_servicio();
    $res6=$guia->code_autocomplete();
    $proy=$guia->proyectos();

    $id_btn="Asociar Servicios / Materiales";
    $id_btn2="Ingresars";
...
<body class="ui-widget">
        ...
        <form name="form_tbl" id="form_tbl" action="" method="post">
            ...
            <table cellspacing="3" align="center" style="width: 100%;" cellpadding="1">
                ...
                <td style="width:150px;">
                    <input <?=$deshabilitar?> type="text" name="contador" style="width: 180px;" class="form-control input-sm ui-corner-all"  id="contador" value="<?=$contador?>" />
                </td>
                ...
                <td style="width:280px;">
                  <table>
                        <tr>
                        <td >
                            <select name="proyecto" id="proyecto" style="width: 350px;"class="span2"  value="">
                ...
                <tr>
                <td><label>Fecha Asignación</label></td>
                <td >
                    <input style="width: 180px;" class="form-control input-sm ui-corner-all" type="text" name="fecha_operacion" id="fecha_operacion" value="<?=$fecha4?>" />
                </td>
                
                <td ><label>Quien Ingresa</label></td>
                <td >
                  <input style="width: 180px;" class="form-control input-sm ui-corner-all" disabled type="text" name="txt_usuario" id="txt_usuario" value="<?php echo $_SESSION["SESS_USERNAME"]?>"/>
            ...
            <tr>
                ...
                <td rowspan="4">
                    <textarea style="width: 345px; max-width: 402px;" class="form-control input-sm ui-corner-all" id="glosa" name="glosa" cols="20" rows="6" ><?=$ord[0]["glosa"]?></textarea>
                </td>
            </tr>
            </table>
        </div><!--Cabecera-->
        ...
        <div id="pie">
            ...
            <table border="0" class="table table-condensed table-bordered" cellspacing="2">
                <tr>
                    ...
                    <td width="10%" align="left"><button type="button" style="float: right;" class="btn btn-primary" name="<?=$id_btn2?>" id="<?=$id_btn2?>"  value=""><?=$id_btn?></button></td>
    ...
    <!--####################################################################################################################-->
        ...
        <h4>Maestro de Productos/Servicios/Materiales</h4>
