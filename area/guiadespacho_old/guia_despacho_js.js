...
$(function() {
      ...
      var creacion = $('#facturacion2').datepicker({
            dateFormat: 'dd-mm-yy'
      });
      ...
      $(".btn-quitar").on('click', function() {
            ...
            //$TR.find('#id_detalles').val('');
            
            //.children("td:eq(0)").children();//
            //valor1= $(this).parent().parent().parent().parent().parent().parent().parent().children("td:eq(2)").children().children().children().children().children("td:eq(0)").children();
            //valor4= $(this).parent().parent().parent().parent().parent().parent().parent().children("td:eq(7)").children().children().children().children().children("td:eq(0)").children();
            
            //valor4= $(this).parent().parent().parent().parent().parent().parent().parent().parent().parent().children().children().children("td:eq(7)").children().children().children().children().children("td:eq(0)").children();
            //valor=$(".cod_complete");
