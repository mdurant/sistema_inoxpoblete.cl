...
<body  class="ui-widget">
    <div id="contenedor">
          <div id="tbl_pri">
            <center><h3>Guia de Despacho</h3></center>
        <form name="form_tbl" id="form_tbl" action="" method="post">
            <div id="cabecera" class="ui-widget-content ui-corner-all">
                ...
                <tbody>
                    ...
                    <td  style="width:100px;">
                        <input class="form-control input-sm ui-corner-all" type="text" value="<?=$res5?>" id="contador" class="span2" name="contador" style="width: 100%" />
                    </td>
                    <td style="width:60px;" align="center">
                        <label for="scliente">Cliente</label>
                    </td>
                    <td style="width:280px;">
                        <select name="scliente" class="span2" id="scliente" style="width: 85%">
                    ...
                    <td rowspan="3">
                        <textarea class="form-control input-sm ui-corner-all" value="" id="glosa" name="glosa" cols="20" rows="4" style="width:130px;"></textarea>
                    </td>
                    </tr>
                    <tr>
                    <td>
                    ...
                    <tr>
                    <td>
                        <label for="facturacion">Fecha Guia</label>
                    </td>
                    <td>
                    ...
                    <td align="center"><label for="motivo">Motivo de Guia</label></td>
                            <td>
                            <select name="motivo" id="motivo" class="form-control input-sm ui-corner-all" value="">
                            <option value="0">--Seleccionar--</option>
                                <?php
                                for($h=0;$h<sizeof($res7);$h++){ ?>
                            <option value="<?=$res7[$h]["IDMotivo"]?>"><?=$res7[$h]["nombre_motivo"]?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <td>
                        ...
                        <td><input type="text" name="rut_chofer" class="form-control input-sm ui-corner-all"> </td>

                    <td><label>Nombre Chofer</label></td>
                    <td><input type="text" name="nom_chofer" class="form-control input-sm ui-corner-all"></td>

                    <td><label>Placa Patente</label></td>
                    <td style="width:85px;"><input type="text" name="patente" class="form-control input-sm ui-corner-all"></td>

                    <td><label>Autorizado por </label></td>
                    <td style="width:190px;">
                        <select name="sautoriza" id="sautoriza" class="form-control input-sm ui-corner-all" value="">
                        <option value="0">--Seleccionar--</option>
                            <?php
                                    for($g=0;$g<sizeof($res8);$g++)
                                    {
                                    ?>
                        <option value="<?php echo $res8[$g]["id_trabajador"]?>"><?php echo $res8[$g]["datos_trabajador"]?></option>
                        <?php
                                    }
                                    ?>
                            </select>
            ...
            <div id="pie">
                ...
                <tr>
                    <td><button class="btn btn-primary" name="btn-factura" id="btn-factura"  value="">Generar Guia Despacho</button></td>
                </tr>
                </table>
